...
class KFServingSampleModel(kfserving.KFModel):
    ...
    def predict(self, request: Dict) -> Dict:
        ...
        #model_ano = tf.keras.models.load_model("/Users/mokpolar/Documents/GitHub/kubeflow/eks/samples/hm/weight/seg/")
        #model_ano.summary()
        ...
        #model_cls = tf.keras.models.load_model("/Users/mokpolar/Documents/GitHub/kubeflow/eks/samples/hm/weight/cls/")
        ...
        logging.info('Classification 완료...')
...
if __name__ == "__main__":
    model = KFServingSampleModel("hm-model")
    model.load()
